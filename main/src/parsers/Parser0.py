...
class Parser0(BaseClass):
    ...
    def __init__(self):
        ...
        self.args = {
                    ...
                    '-augmentations_patch':['augmentations_patch',"mirrors,rotation,resize_4_1.5",str,"Indicate the augmentations to apply to patches in the order desired seprated by commas"],
                    # Model
