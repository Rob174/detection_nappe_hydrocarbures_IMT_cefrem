...
class Parser0(BaseClass):
    ...
    def __init__(self):
        ...
        self.args = {
            ...
            '-no_security': {"dest": 'no_security', "default": EnumGitCheck.GITCHECK, "type": EnumGitCheck,
            ...
            '-patch': {"dest": 'patch', "default": "fixed_px", "type": EnumPatchAlgorithm,
                       "help": "Indicate the type of patch to create", "choices": list(EnumPatchAlgorithm)},
            '-patchExclPol': {"dest": "patch_exclude_policy", "default": EnumPatchExcludePolicy.MarginMoreThan,
            ...
            '-augmentations_img': {"dest": 'augmentations_img', "default": "combinedRotResizeMir_10_0.25_4",
                                   "type": str,
                                   "help": "Indicate the augmentations to apply to images in the order desired seprated by commas"},
            ...
            # Model
            '-model': {"dest": 'model', "default": EnumModels.Vgg16, "type": EnumModels,
            ...
            # Training
            '-num_epochs': {"dest": 'num_epochs', "default": 70, "type": int,
